...
"""
8-1. Restaurant: Make a class called Restaurant. The __init__() method for
...
class Restaurant:
    ...
    def describe_restaurant(self):
        print(f"In {self.restaurant_name}, everyone is welcome!")
...
print(f"Our restaurant's name is {restaurant.restaurant_name}")
